...
%% InitPX4ControllerVars
% Codegenration Configuration
TargetHardware = "SITL";

%TargetHardware = "PX4orHILS";
IDLEPWM = 900;
...
% Model Sample Time
% Sample Time of Plant and Controller
SampleTime = 0.004;
...
MC_YAWRATE_MAX = 200;
MPC_Z_VEL_MAX_DN = 2; % m/s
MPC_Z_VEL_MAX_UP = 2; % m/s
MPC_XY_VEL_MAX = 4; % m/s
