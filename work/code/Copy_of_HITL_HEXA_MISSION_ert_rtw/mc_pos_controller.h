...
extern void Copy_of_HITL_HEXA_MISSION_mc_pos_controller_Init(void);
extern void Copy_of_HITL_HEXA_MISSION_mc_pos_controller(void);
extern void Copy_of_HITL_HEXA_MISSION_mc_pos_controller_Term(void);
