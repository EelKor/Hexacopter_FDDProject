###########################################################################
## Makefile generated for component 'QP_CA_Codegen'. 
## 
## Makefile     : QP_CA_Codegen.mk
## Generated on : Fri Dec 27 13:44:14 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\QP_CA_Codegen.exe
...
COMPILER_COMMAND_FILE     = QP_CA_Codegen_comp.rsp
CMD_FILE                  = QP_CA_Codegen.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\QP_CA_Codegen.exe
...
DEFINES_STANDARD = -DMODEL=QP_CA_Codegen -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\QP_CA_Codegen_ert_rtw\QP_CA_Codegen.cpp

MAIN_SRC = $(START_DIR)\QP_CA_Codegen_ert_rtw\ert_main.cpp
...
{$(START_DIR)\QP_CA_Codegen_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\QP_CA_Codegen_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\QP_CA_Codegen_ert_rtw}.cc.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\QP_CA_Codegen_ert_rtw}.cxx.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
QP_CA_Codegen.obj : "$(START_DIR)\QP_CA_Codegen_ert_rtw\QP_CA_Codegen.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\QP_CA_Codegen_ert_rtw\QP_CA_Codegen.cpp"


ert_main.obj : "$(START_DIR)\QP_CA_Codegen_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\QP_CA_Codegen_ert_rtw\ert_main.cpp"
