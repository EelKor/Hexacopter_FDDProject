...
extern void SITL_HEXA_Hovering_actuatorOutputs_Init(void);
extern void SITL_HEXA_Hovering_actuatorOutputs(void);
extern void SITL_HEXA_Hovering_actuatorOutputs_Term(void);
