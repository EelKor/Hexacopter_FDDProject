...
//
// File: FLIGHT_Hexacopter_fromNCMS_types.h
//
...
//
#ifndef FLIGHT_Hexacopter_fromNCMS_types_h_
#define FLIGHT_Hexacopter_fromNCMS_types_h_
#include "rtwtypes.h"
...
// Custom Type definition for MATLABSystem: '<S4>/Read Parameter5'
#include "MW_Parameter.h"
...
typedef struct P_FLIGHT_Hexacopter_fromNCMS_T_ P_FLIGHT_Hexacopter_fromNCMS_T;

// Forward declaration for rtModel
typedef struct tag_RTM_FLIGHT_Hexacopter_fro_T RT_MODEL_FLIGHT_Hexacopter_fr_T;

#endif                                 // FLIGHT_Hexacopter_fromNCMS_types_h_
