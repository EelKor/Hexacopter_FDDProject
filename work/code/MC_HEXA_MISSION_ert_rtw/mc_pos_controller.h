...
extern void MC_HEXA_MISSION_mc_pos_controller_Init(void);
extern void MC_HEXA_MISSION_mc_pos_controller(void);
extern void MC_HEXA_MISSION_mc_pos_controller_Term(void);
